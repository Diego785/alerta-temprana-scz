    ...
    <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/gestion/alert') }}"
                        class="text-sm text-gray-700 dark:text-gray-500 underline">Gestión</a>
                @else
                    ...
                    <div>
                        ...
                        <div id="buttons-container"
                            ...
                            <button id="alert-button" onclick="change()"
                                class="increase-btn w-40 grado border-2 bg-gradient-to-t from-[#007338] to-[#8CBF44] border-green-600 rounded-lg px-3 py-2 text-white cursor-pointer hover:bg-green-600 hover:text-green-200">
                                Mostrar Alertas
                            </button>
