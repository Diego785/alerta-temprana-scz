<div>
    <aside style="background: url(https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Escudo_de_Santa_Cruz_de_la_Sierra.svg/1200px-Escudo_de_Santa_Cruz_de_la_Sierra.svg.png); background-size:contain; background-repeat:no-repeat; background-position: center;"
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">These companies have purchased in the last 12
                    months.</p>
                        ...
                        <div class="flex items-center mt-4 gap-x-3">
                            ...
                            <button
                                class="flex items-center justify-center w-40 grado border-2 bg-gradient-to-t from-blue-400 to-cyan-900 border-blue-300 rounded-lg px-3 py-2 text-white cursor-pointer hover:bg-blue-600 hover:text-black">
                    ...
                    <div class="mt-6 md:flex md:items-center md:justify-between">
                        ...
                        <div class="relative flex items-center mt-4 md:mt-0">
                            ...
                            <input type="text" placeholder="Busca por el nombre o el ID"
                                        ...
                                        <tbody
                                            ...
                                            <tr>
                                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">Catalog
                                                        </h2>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div>
                                                        <h4 class="text-gray-700 dark:text-gray-200">Content curating
                                                            app</h4>
                                                        <p class="text-gray-500 dark:text-gray-400">Brings all your news
                                                            into
                                                            one
                                                            place</p>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div>
                                                        <h4 class="text-gray-700 dark:text-gray-200">Design software
                                                        </h4>
                                                        <p class="text-gray-500 dark:text-gray-400">Super lightweight
                                                            design
                                                            app
                                                        </p>
                                                    </div>
                                            ...
                                            <tr>
                                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">Sisyphus
                                                        </h2>
                                                        <p
                                                            class="text-sm font-normal text-gray-600 dark:text-gray-400">
                                                            sisyphus.com</p>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div>
                                                        <h4 class="text-gray-700 dark:text-gray-200">Automation and
                                                            workflow
                                                        </h4>
                                                        <p class="text-gray-500 dark:text-gray-400">Time tracking,
                                                            invoicing
                                                            and
                                                            expenses</p>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div>
                                                        <h4 class="text-gray-700 dark:text-gray-200">Productivity app
                                                        </h4>
                                                        <p class="text-gray-500 dark:text-gray-400">Time management and
                                                            productivity</p>
                                                    </div>
                                                </td>
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            ...
                                            <tr>
                                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">Quotient
                                                        </h2>
                                                        <p
                                                            class="text-sm font-normal text-gray-600 dark:text-gray-400">
                                                            quotient.co
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div>
                                                        ...
                                                        <p class="text-gray-500 dark:text-gray-400">Web-based sales doc
                                                            management
                                                        </p>
                                                    </div>
                                                </td>
