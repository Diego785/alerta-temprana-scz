                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                        <div>
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400">Super lightweight design app
                                            </p>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                ...
                                <tr>
                                    <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                        <div>
                                            ...
                                            <p class="text-sm font-normal text-gray-600 dark:text-gray-400">quotient.co
                                            </p>
                                        </div>
                                    </td>
                                    <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                    ...
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                        <div>
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400">Web-based sales doc management
                                            </p>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
