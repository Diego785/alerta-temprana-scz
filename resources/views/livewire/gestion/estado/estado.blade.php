                ...
                <div class="py-2 sm:px-6 lg:px-8">
                    <table class="table-auto divide-y divide-gray-900 w-full">
                        <thead class="bg-green-800 border-b">
                            <tr>
                                <th scope="col" class="text-base font-medium text-white px-10 py-4 text-center">
                                    ID
                                </th>
                                <th scope="col" class="text-base font-medium text-white px-10 py-4 text-center">
                                    Nombre
    ...
    <x-jet-dialog-modal wire:model="modal_add">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" class="w-full" wire:model.defer="color" placeholder='Escriba el color' />
