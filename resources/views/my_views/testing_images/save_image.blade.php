...
<body>
    ...
    <div id="button" class="hidden container mx-auto flex justify-center items-center px-4 md:px-10 py-20">
        ...
        <button onclick="openModal()"
            class="bg-white text-gray-800 py-5 px-10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white rounded">Open
            Modal</button>
    </div>
    <div id="modal" class="container mx-auto flex justify-center items-center px-4 md:px-10 py-20">
        ...
        <div class="bg-white dark:bg-gray-800 px-3 md:px-4 py-12 flex flex-col justify-center items-center">
            <div role="img" aria-label="Luxe. Logo.">
                <svg class="text-gray-900 dark:text-white" width="54" height="24" viewBox="0 0 54 24"
                    fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M4.9521 20.3965C4.9521 21.1843 5.12115 21.7319 5.45924 22.0394C5.79734 22.3276 6.38403 22.4717 7.21933 22.4717V23.077C5.38964 23.0001 4.18642 22.9617 3.60966 22.9617C3.03291 22.9617 1.82969 23.0001 0 23.077V22.4717C0.835294 22.4717 1.42199 22.3276 1.76008 22.0394C2.09818 21.7319 2.26723 21.1843 2.26723 20.3965V3.93912C2.26723 3.05524 2.09818 2.41155 1.76008 2.00804C1.42199 1.60453 0.835294 1.40277 0 1.40277V0.797511C0.616527 0.855155 1.23305 0.883977 1.84958 0.883977C3.10252 0.883977 4.13669 0.749475 4.9521 0.480469V20.3965Z"
                        fill="currentColor" />
                    <path
            ...
            <h1
                ...
                IMAGE SAVED!</h1>
            <p class="mt-10 text-base leading-normal text-center text-gray-600 md:w-9/12 lg:w-7/12 dark:text-white">A
                confirmation email has been sent to your account, johndoe@gmail.com, with the details of shipping and
                delivery.</p>
            <div class="mt-12 md:mt-14 w-full flex justify-center">
                <button onclick="closeModal()"
                    class="dark:text-white dark:border-white w-full sm:w-auto border border-gray-800 text-base font-medium text-gray-800 py-5 px-14 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 hover:bg-gray-800 hover:text-white dark:hover:text-white dark:hover:bg-gray-700">Back
                    to store</button>
            </div>
        </div>
    </div>
