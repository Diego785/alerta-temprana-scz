    ...
    <div class="content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
        ...
        <div id="main-background" class="py-32 h-full"
            ...
            <div class="lg:mx-60 md:mx-30 sm:mx-20 xs:mx-10" x-data="{ showPass: true }">
                ...
                <nav class="flex px-5 py-5 my-10 text-gray-700  rounded-lg bg-gray-50 dark:bg-[#1E293B] "
                ...
                <div class="flex flex-wrap my-5 -mx-2">
                    <div class="w-full lg:w-1/3 p-2">
                        <div
                            class="flex items-center flex-row w-full bg-gradient-to-r dark:from-green-500 dark:to-green-900 from-green-700 via-green-400 to-white rounded-md p-3">
                            <div
