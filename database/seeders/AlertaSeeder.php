...
class AlertaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Ejemplo Real Incendio Forestal
        Alerta::create([
            'nombre' => 'Incendio Forestal en la Chiquitanía.',
            'fecha' => '2023-03-21',
            'hora' => '21:36:00',
            'description' => 'El Gobierno Autónomo Departamental de Santa Cruz y  la  Secretaria Departamental  de Seguridad Ciudadana  través  de su Brazo Operativo  de la Dirección de Gestión de Riesgos  con su Unidad  de Alerta Temprana,  de acuerdo al monitoreo que se realiza y se socializa los boletines de alerta y recomendaciones de prevención  , podemos  describir el  procesos de la alerta. A raíz  de las  variaciones climáticas que han y están ocasionando: déficit de precipitación - estrés hídrico - sequía e incendios forestales, iniciando el en el Municipio.',
            'tipo' => 'Meteorológica',
            // 'foto' => json_encode(['imgs/incendio_estructural/1.jpg', 'imgs/incendio_estructural/2.jpg', 'imgs/incendio_estructural/3.jpg', 'imgs/incendio_estructural/4.jpg', 'imgs/incendio_estructural/5.jpg']),
            'geoX' => -10,
            'geoY' => -15,
