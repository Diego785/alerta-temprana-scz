...
class MunicipioSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Municipio::create([
            'nombre' =>'Puerto Suarez',
            'provincia'=>'German Bush',         
        ]);
        Municipio::create([
            'nombre' =>'Asencion de Guarayos',
            'provincia'=>'Guarayos',         
        ]);
        Municipio::create([
            'nombre' =>'El puente',
        ...
        Municipio::create([
            'nombre' =>'San Ignacion de Velasco',
            'provincia'=>'Velasco',         
        ]);
        Municipio::create([
